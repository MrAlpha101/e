module.exports = {
  ...
  SupportServer: "https://discord.gg/simpz", // Support Server Link
  Token: process.env.Token || "MTAwMjYwNzU4ODg0MTYzNTk5MA.Gfs4JZ.Bx_FiciHWUspmoKYf5eqSUlc08fbLK438RfM9M", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1002607588841635990", // Discord Client ID
  ...
  Presence: {
    ...
    name: ".gg/simpz", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "cbcc3c5f92254a1a93bb660f6529ed65", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "d46b5d765f2d497f936ab557fa349d35", // Spotify Client Secret
  },
};
